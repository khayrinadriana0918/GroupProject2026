...
public class IncidentRouting {
    ...
    private void displayQueueDetails(Queue<AnalystInfo> queue) {
        ...
        for (AnalystInfo analyst : queue) {
            ...
            //use method on AnalystInfo 
            double analystImpact = analyst.getTotalImpactCost();
